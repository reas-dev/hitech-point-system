...
<body class="grey lighten-4">
    ...
    <nav>
        <div class="nav-wrapper">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="{{ url('developer') }}">Visitor Check</a></li>
                <li><a href="{{ url('developer/profile') }}">Profile</a></li>
                <li><a href="{{ url('developer/guidelines') }}">Guidelines</a></li>
      ...
      <ul class="sidenav indigo darken-4" id="mobile-demo">
          <div class="background">
            <li><a class="waves-effect white-text" href="{{ url('developer') }}"><i
                class="material-icons white-text">rate_review</i>Visitor Check</a></li>
                <div class="divider"></div>
                <li><a class="waves-effect white-text" href="{{ url('developer/profile') }}"><i
                    class="material-icons white-text">face</i>Profile</a></li>
                <li><a class="waves-effect white-text" href="{{ url('developer/guidelines') }}"><i
    ...
    <script>
        ...
        Swal.fire({
            icon: 'error',
            title: 'Ups!',
            text: 'Pengunjung belum bisa anda nilai',
        ...
        <script>
            ...
            icon: 'error',
            title: 'Ups!',
            text: 'Pengunjung sudah pernah dinilai',
            showConfirmButton: false,
            timer: 1500
            })
        </script>
